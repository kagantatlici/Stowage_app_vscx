...
let parcels = [
  { id: 'P1', name: 'Parcel 1', total_m3: 4000, density_kg_m3: 800, temperature_c: 20, color: '#ef4444' },
  { id: 'P2', name: 'Parcel 2', fill_remaining: true, density_kg_m3: 850, temperature_c: 20, color: '#22c55e' }
];
